...
export class SystemContent {
    ...
    public VisitorUser = { Id: 4, Username: "Visitor", Password: "", Roles: [this.VisitorRole] } as any as ISavedContent<User>;
    public AdminUser = { Id: 5, Username: "Admin", Password: "", Roles: [this.AuthenticatedRole, this.AdminRole] } as any as ISavedContent<User>;
}
