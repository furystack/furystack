      ...
      <>
        ...
        <Input
          ...
          getValidationResult={({ state }) => {
            const rawData = formService.rawFormData.getValue()
            const password = rawData ? rawData.password : null
    ...
    return (
      <Paper elevation={3} style={{ padding: '32px', marginTop: '24px' }}>
        ...
        <Typography variant="body1" style={{ opacity: '0.7' }}>
          An event registration form showcasing all input components with validation, dividers, tooltips, and submission
          feedback alerts.
        </Typography>
